...
module Types::Resource
  ...
  orphan_types Types::GenericWorkType,
               Types::MonographType,
  ...
  field :members, [Types::Hyrax::FileSetType], null: true
  ...
  def thumbnail_resource
    @thumbnail_resource ||=
      members.find do |member|
        member.id == object.try(:thumbnail_id)
      end || query_service.find_by(id: object.try(:thumbnail_id))
